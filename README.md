...
- **[CHANGELOG.md](./CHANGELOG.md)** — Keep a Changelog (current: **1.2.0**)
...
```bash
# After CHANGELOG has ## [1.2.0] and versions are bumped
git tag v1.2.0
...
|-------|------------|------|
| `ghcr.io/codesteward/codesteward` | `deploy/compose/Dockerfile.node` (API; `SERVICE=worker` for workers) | product semver (`1.2.0`) |
